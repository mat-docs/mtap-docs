...
The library could consume pure JSON text messages or Protobuf encoded messages of the [known types](https://github.com/mat-docs/mtap-docs/blob/master/AAS/2020.2/resources/protocol.proto).
