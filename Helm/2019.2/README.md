...
You can find more extensive documentation in [InfluxDb writer documentation](https://github.com/McLarenAppliedTechnologies/mat.tap.aas.influxdb/blob/task/master/docs/SeedData.md).
